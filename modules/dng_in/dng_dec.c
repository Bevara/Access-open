...
static u32 DNG_CanHandleStream(GF_BaseDecoder *dec, u32 StreamType, GF_ESD *esd, u8 PL)
{
...
GF_BaseDecoder *NewBaseDecoder()
{
	...
	ifce->CanHandleStream = DNG_CanHandleStream;

	GF_REGISTER_MODULE_INTERFACE(ifce, GF_MEDIA_DECODER_INTERFACE, "GPAC RAW Image Decoder", "Bevara Technologies")
