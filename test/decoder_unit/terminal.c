...
int terminal(const char *file)
{
	...
	//TODO : clean up
	gf_cfg_set_key(user.config, "Systems", "DefImageDec", "Accessor Decoder");
	gf_cfg_set_key(user.config, "Systems", "DefVideoDec", "Accessor Decoder");
	gf_cfg_set_key(user.config, "Systems", "DefAudioDec", "Accessor Decoder");
