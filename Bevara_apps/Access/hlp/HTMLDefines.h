...
// Commandes (ID_* et IDM_*) 
#define HID_EXTRACT_DATA                        0x10065
#define HID_MAINSLIDER                          0x100AB
#define HID_AUDIO_VOL                           0x103EA
#define HID_SLIDER                              0x10440
#define HID_FILE_EXIT                           0x1045A
#define HID_HELP_ABOUT                          0x1045B
#define HID_PLAYLIST_LOOP                       0x1045C
#define HID_OPEN_FILE                           0x1045D
#define HID_VIEW_CONTROL                        0x1045E
#define HID_VIEW_ORIGINAL                       0x1045F
#define HID_VIEW_FULLSCREEN                     0x10460
#define HID_AR_KEEP                             0x10461
#define HID_SHORTCUTS                           0x10465
#define HID_FILE_RESTART                        0x10466
#define HID_OPT_QUALITY                         0x10467
#define HID_FILE_PROP                           0x10468
#define HID_FILE_STEP                           0x10469
#define HID_VIEW_SCALABLE                       0x1046B
#define HID_OPEN_URL                            0x1046C
#define HID_FILE_RELOAD                         0x1046D
#define HID_FILE_PLAY                           0x1046E
#define HID_ACCESSBETATESTLINK                  0x1046E
#define HID_NAVIGATE_NONE                       0x1046F
#define HID_BETA_CANCEL                         0x1046F
#define HID_BETA_CLOSE                          0x1046F
#define HID_NAVIGATE_WALK                       0x10470
#define HID_NAVIGATE_FLY                        0x10471
#define HID_NAVIGATE_EXAM                       0x10472
#define HID_NAVIGATE_PAN                        0x10473
#define HID_NAVIGATE_SLIDE                      0x10474
#define HID_NAVIGATE_GAME                       0x10475
#define HID_AR_FILL                             0x10476
#define HID_AR_43                               0x10477
#define HID_AR_169                              0x10478
#define HID_FILE_MIGRATE                        0x10479
#define HID_NAV_RESET                           0x1047F
#define HID_FILE_STOP                           0x10480
#define HID_FILE_PREV                           0x10483
#define HID_FILE_NEXT                           0x10484
#define HID_FILE_PROPS                          0x10485
#define HID_SWITCH_RENDER                       0x10486
#define HID_RELOAD_TERMINAL                     0x10487
#define HID_VIEW_PLAYLIST                       0x10488
#define HID_NAVIGATE_ORBIT                      0x10489
#define HID_COLLIDE_NONE                        0x1048A
#define HID_COLLIDE_REG                         0x1048B
#define HID_COLLIDE_DISP                        0x1048C
#define HID_GRAVITY                             0x1048D
#define HID_HEADLIGHT                           0x1048E
#define HID_NAV_INFO                            0x1048F
#define HID_NAV_PREV                            0x10490
#define HID_NAV_NEXT                            0x10491
#define HID_CLEAR_NAV                           0x10492
#define HID_TIMER                               0x10493
#define HID_FPS                                 0x10494
#define HID_VIEWPORT_EMPTY                      0x10495
#define HID_PL_REM_ALL                          0x10496
#define HID_PL_REM_DEAD                         0x10497
#define HID_PL_ADD_DIR_REC                      0x10498
#define HID_PL_ADD_FILE                         0x10499
#define HID_PL_REM_FILE                         0x1049A
#define HID_PL_OPEN                             0x1049B
#define HID_PL_SAVE                             0x1049C
#define HID_PL_UP                               0x1049D
#define HID_PL_DOWN                             0x1049E
#define HID_VIEW_PL                             0x1049F
#define HID_PL_ADD_DIR                          0x104A0
#define HID_PL_ADD_URL                          0x104A1
#define HID_PL_PLAY                             0x104A2
#define HID_PL_SEL_REV                          0x104A3
#define HID_PL_SORT_TITLE                       0x104A4
#define HID_PL_SORT_FILE                        0x104A5
#define HID_PL_SORT_DUR                         0x104A6
#define HID_PL_SORT_REV                         0x104A7
#define HID_PL_RANDOM                           0x104A8
#define HID_ADD_SUBTITLE                        0x104A9
#define HID_NAVIGATE_VR                         0x104AA
#define HID_REC_ENABLE                          0x104AB
#define HID_REC_STOP                            0x104AC
#define HID_REC_ABORT                           0x104AD
#define HID_AUDIO_EMPTY                         0x104AE
#define HID_VIDEO_EMPTY                         0x104AF
#define HID_SUBS_EMPTY                          0x104B0
#define HID_VIEW_CPU                            0x104B1
#define HID_VP_0                                0x10514
#define HID_VP_1                                0x10515
#define HID_VP_2                                0x10516
#define HID_VP_3                                0x10517
#define HID_VP_4                                0x10518
#define HID_VP_5                                0x10519
#define HID_VP_6                                0x1051A
#define HID_VP_7                                0x1051B
#define HID_VP_8                                0x1051C
#define HID_VP_9                                0x1051D
#define HID_VP_10                               0x1051E
#define HID_VP_11                               0x1051F
#define HID_VP_12                               0x10520
#define HID_VP_13                               0x10521
#define HID_VP_14                               0x10522
#define HID_VP_15                               0x10523
#define HID_VP_16                               0x10524
#define HID_VP_17                               0x10525
#define HID_VP_18                               0x10526
#define HID_VP_19                               0x10527
#define HID_NAV_PREV_0                          0x10528
#define HID_NAV_PREV_1                          0x10529
#define HID_NAV_PREV_2                          0x1052A
#define HID_NAV_PREV_3                          0x1052B
#define HID_NAV_PREV_4                          0x1052C
#define HID_NAV_PREV_5                          0x1052D
#define HID_NAV_PREV_6                          0x1052E
#define HID_NAV_PREV_7                          0x1052F
#define HID_NAV_PREV_8                          0x10530
#define HID_NAV_PREV_9                          0x10531
#define HID_NAV_NEXT_0                          0x10532
#define HID_NAV_NEXT_1                          0x10533
#define HID_NAV_NEXT_2                          0x10534
#define HID_NAV_NEXT_3                          0x10535
#define HID_NAV_NEXT_4                          0x10536
#define HID_NAV_NEXT_5                          0x10537
#define HID_NAV_NEXT_6                          0x10538
#define HID_NAV_NEXT_7                          0x10539
#define HID_NAV_NEXT_8                          0x1053A
#define HID_NAV_NEXT_9                          0x1053B
#define HID_SELOBJ_0                            0x1053C
#define HID_SELOBJ_1                            0x1053D
#define HID_SELOBJ_2                            0x1053E
#define HID_SELOBJ_3                            0x1053F
#define HID_SELOBJ_4                            0x10540
#define HID_SELOBJ_5                            0x10541
#define HID_SELOBJ_6                            0x10542
#define HID_SELOBJ_7                            0x10543
#define HID_SELOBJ_8                            0x10544
#define HID_SELOBJ_9                            0x10545
#define HID_SELOBJ_10                           0x10546
#define HID_SELOBJ_11                           0x10547
#define HID_SELOBJ_12                           0x10548
#define HID_SELOBJ_13                           0x10549
#define HID_SELOBJ_14                           0x1054A
#define HID_SELOBJ_15                           0x1054B
#define HID_SELOBJ_16                           0x1054C
#define HID_SELOBJ_17                           0x1054D
#define HID_SELOBJ_18                           0x1054E
#define HID_SELOBJ_19                           0x1054F
#define HID_SELOBJ_20                           0x10550
#define HID_SELOBJ_21                           0x10551
#define HID_SELOBJ_22                           0x10552
#define HID_SELOBJ_23                           0x10553
#define HID_SELOBJ_24                           0x10554
#define HID_SELOBJ_25                           0x10555
#define HID_SELOBJ_26                           0x10556
#define HID_SELOBJ_27                           0x10557
#define HID_SELOBJ_28                           0x10558
#define HID_SELOBJ_29                           0x10559
#define HID_SETCHAP_FIRST                       0x107D0
#define HID_SETCHAP_LAST                        0x10898
#define HID_FILE_COPY                           0x180C1
#define HID_FILE_PASTE                          0x180C2
#define HID_CONFIG_RELOAD                       0x180C3
#define HID_HELP_CONTENTS                       0x180D6
#define HID_HELP_TUTORIAL                       0x180D7
#define HID_HELP_CONTACT                        0x180D8
#define HID_HELP_BETATESTFEEDBACK               0x180D9
 
// Demandes (IDP_*) 
 
// Ressources (IDR_*) 
#define HIDR_MAINFRAME                          0x20080
#define HIDR_GPACTYPE                           0x20081
#define HIDR_MAINTOOLS                          0x200AA
#define HIDR_PLAYLIST                           0x200B2
#define HIDR_MENUPL                             0x200B6
#define HIDR_MAINACCEL                          0x200BE
#define HIDR_HTML1                              0x200CA
 
// Boåtes de dialogue (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_CONTROL                            0x20084
#define HIDD_OPTIONS                            0x20098
#define HIDD_OPT_GEN                            0x2009A
#define HIDD_OPT_RENDER                         0x2009B
#define HIDD_OPT_AUDIO                          0x2009D
#define HIDD_OPT_VIDEO                          0x2009E
#define HIDD_OPT_HTTP                           0x2009F
#define HIDD_OPT_FONT                           0x200A1
#define HIDD_OPT_SYSTEMS                        0x200A2
#define HIDD_OPT_STREAM                         0x200A4
#define HIDD_PROPERTIES                         0x200A6
#define HIDD_OPT_DECODER                        0x200A7
#define HIDD_OPT_RENDER2D                       0x200A8
#define HIDD_OPT_RENDER3D                       0x200A9
#define HIDD_SLIDERS                            0x200AD
#define HIDD_PLAYLIST                           0x200B1
#define HIDD_OPT_FILETYPES                      0x200B3
#define HIDD_PASSWD                             0x200BC
#define HIDD_DIALOG1                            0x200C9
#define HIDD_HELP_CONTACT                       0x200C9
#define HIDD_BETATESTDIALOG                     0x200CB
#define HIDD_OPT_MCACHE                         0x20413
#define HIDD_OPENFILE                           0x20417
#define HIDD_CONFIGURE                          0x2046A
#define HIDD_OPT_LOGS                           0x204CA
 
// Contrìles Frame (IDW_*) 
